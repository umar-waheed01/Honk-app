...
//       console.log("Firebase object:", userCredential);
...
// const birthDate = `${date.year}-${String(date.month + 1).padStart(2, "0")}-${String(
//   date.day
// ).padStart(2, "0")}`;
// const requestBody = {
//   birthDate,
...
// };
// try {
//   const result = await apiCall("api/account/signup", "POST", requestBody);
//   setLoading(false);
//   if (result.status === 200) {
//     Toast.show({
//       type: "success",
//       text1: translation.WIZARD.THANKS.emailinformation,
//     });
//     navigation.navigate("Login");
